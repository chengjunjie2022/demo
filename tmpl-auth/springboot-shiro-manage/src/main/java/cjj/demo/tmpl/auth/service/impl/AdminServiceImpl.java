...
public class AdminServiceImpl extends ServiceImpl<AdminMapper, Admin> implements IAdminService {
    ...
    public Admin getAdminByLoginName(String loginName){
        List<Admin> adminList = getBaseMapper().selectList(new QueryWrapper<Admin>().lambda()
    ...
    public List<Role> getRoleByAdminid(Long adminid) {
        List<AdminRole> adminRoleList = adminRoleService.getBaseMapper().selectList(new QueryWrapper<AdminRole>().lambda()
    ...
    public List<Permission> getPermissionByAdminid(Long adminid) {
        ...
        List<RolePermission> rolePermissionList = rolePermissionService.getBaseMapper().selectList(new QueryWrapper<RolePermission>().lambda()
